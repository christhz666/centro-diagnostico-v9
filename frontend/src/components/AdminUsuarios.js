...
const AdminUsuarios = () => {
  ...
  const abrirCrear = () => {
    setEditando(null);
    setFormData({ nombre: '', apellido: '', email: '', password: '', role: 'recepcion', telefono: '', especialidad: '' });
    setShowModal(true);
  };
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ background: '#f8f9fa' }}>
              ...
              <th style={{ padding: 15, textAlign: 'left', color: '#666', fontWeight: 600 }}>Email</th>
              ...
              usuarios.map((u) => {
                ...
                return (
                  <tr key={u._id || u.id} style={{ borderBottom: '1px solid #eee' }}>
                    ...
                    <td style={{ padding: 15, color: '#555' }}>{u.email}</td>
